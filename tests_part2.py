...
class HW4Tests(unittest.TestCase):
    ...
    def test_input16(self): #ArrayValue([1, 2, 6, 7, 8, 9, 3, 4, 5])
            testinput16 = """
    ...
    def test_input37(self): # SHOULD BE [TRUE, TRUE, TRUE] IS [FALSE, FALSE, FALSE]
            testinput37 = """
    ...
    def test_input38(self):
            testinput38 = """3 5 add 2 mul 10 sub"""
    ...
    def test_input39(self):
            testinput39 = """/square {dup mul} def 4 square"""
    ...
    def test_input40(self):
            testinput40 = """[1 2 3 4 5] {2 mul} forall"""
    ...
    def test_input41(self):
            testinput41 = """10 5 gt { 100 } { 50 } ifelse 20 add"""
